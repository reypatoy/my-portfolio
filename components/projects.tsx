...
export default function Projects() {
    return (
        <div id="projects" className="flex-1 flex flex-col items-center scroll-mt-20">
            <h1 className="text-[#9CA3AF] font-bold text-3xl py-4 px-20 border-t-1 border-b-1">Projects</h1>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full mt-15">
                <div className="flex-1 flex flex-row flex-wrap">
                    <ProjectCard title="Backlog-Buddy (November 2025 - May 2026)" className="">
                        <p className="text-lg">Interact with the client through virtual meetings & feature implementation.</p>
                        ...
                        <p className="text-lg">Built dynamic client workflow. Secure multi-tenant architecture with AI orchestration.</p>
                    </ProjectCard>
                </div>
                <div className="flex flex-1 flex-row flex-wrap">
                    <ProjectCard title="AI Blog Generation (August 2025 - Present)">
                        ...
                        <p className="text-lg">Restructured API orchestration, ensuring robust content generation pipelines.</p>
                    </ProjectCard>
                </div>
                <div className="flex-1 flex flex-row flex-wrap">
                    <ProjectCard title="Map Engine Optimization Report (October 2025 - Present)" className="">
                        ...
                        <p className="text-lg">Enable real-time updates and drastically reduced RAM footprint during processing.</p>
                    </ProjectCard>
                </div>
                <div className="flex flex-1 flex-row flex-wrap">
                    <ProjectCard title="Treasure Keyword Search (May 2025 - Present)">
                        ...
                        <p className="text-lg">Engineered scalable sraping architecture using Docker and AWS Batch for heavy process as well as background task.</p>
                    </ProjectCard>
                </div>
                <div className="flex-1 flex flex-row flex-wrap">
                    <ProjectCard title="Search Engine Optimization Keyword Monitoring (November 2024 - Present)" className="">
                        ...
                        <p className="text-lg">Designed end-to-end data pipelines for detailed keyword and site analytic dashboard.</p>
                    </ProjectCard>
                </div>
                <div className="flex flex-1 flex-row flex-wrap">
                    <ProjectCard title="Map Engine Optimization Registration (April 2024 - October 2024)">
                        ...
                        <p className="text-lg">Engineered scalable scraping architecture using Docker and AWS Batch for heavy process as well as background task.</p>
                    </ProjectCard>
                </div>
            </div>
            <div className="flex flex-1 flex-row flex-wrap mt-4 w-full">
                    <ProjectCard title="Japanese Learning (March 2023 - February 2024)">
                        <p className="text-lg">Implement the UI from the design provided by the client, and connect to the backend api and fixes some bugs during the connection.</p>
                        <div className="flex flex-wrap gap-2">
                        ...
                        <p className="text-lg">Manage frontend and backend connections to interact perfectly.</p>
                    </ProjectCard>
                </div>
        </div>
    )
